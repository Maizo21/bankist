...
//Se modifican los estilos, en este caso las medidas del height
message.style.height =
  Number.parseFloat(getComputedStyle(message).height, 10) + 30 + 'px';

//Se cambia una propiedad por otra
...
//Don't use. Rewrite all clases for this
...
const alertH1 = function (e) {
  alert('addEvent: Great! You are reading the heading :D');
};
